...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
    ...
    ON_WM_LBUTTONDBLCLK()
	ON_COMMAND(ID_LANDSCAPING_FIXROADS, &CChildView::OnLandscapingFixRoads)
...
/** This function handles road menu option
 *
 */
...
/** This function handles coal mine menu option
 *
 */
...
/** This function handles Count menu option
 * 
 */
...
/** This function handles Fix Roads menu option
 * 
 */
void CChildView::OnLandscapingFixRoads()
{
	CIsRoadVisitor visitor;
	mCity.Accept(&visitor);
}

/** This function handles the check mouse tracks option
 *
 */
...
/** This function handles mouse tracks menu option
 *
 */
